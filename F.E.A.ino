...
int senhadesejada[] = {2, 3, 5, 1};   //Variavel para armazenar a senha correta 
...
void trataSenhaErrada(void)
{
  ...
  esperaBotao(10000); // aguarda que aperte o botao ou que passem 10 segundos
  resetSenha();      // prepara tudo para comecar nova tentativa de entrar a senha
  delay(50);        // espera um pouco para tudo se acalmar
}
